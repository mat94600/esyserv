...
                                     
    ...
    var compteur = 2;
    btnsTemoignages.bind("click", function(){
        var last = $(".overflowTemoignages > .col-md-6").length;
        console.log(compteur +""+ last);

        thisID  =   $(this).attr("id");

        if(thisID == "Next" && compteur < last){
            compteur = compteur +1;
        }
...
/*============= HOME SLIDER */
    ...
    $(".bjqs-markers li:first-child a").text("Une organisation maîtrisée");
