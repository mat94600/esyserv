...
<?php if(is_page()) : ?>
					...
					<?php
						...
						foreach ($result as $pages_enfants) {
							...
							if($pages_enfants->post_title !== 'Solutions' && $pages_enfants->post_title !== 'Offres' && $pages_enfants->post_title !== 'Partenaires'){
								...
								//Pour activer "erp-sap" enlever la condition (127 == identifiant de erp-sap)
								if($pages_enfants->ID !== 127): 
	...
	<?php if($nom): ?>
		...
		<div class="widget b_bleu onglet">
			...
			<div class="lato widget-content">
				...
				<dov class="te!"> <?php echo $telephone; ?></dov>
	...
	<?php if($telephone):?>
		<div class="widget b_bleu onglet">
			...
			<div class="lato widget-content">
				<div class="adr_left"><?php echo get_option('adresse_axaltec'); ?></div>
